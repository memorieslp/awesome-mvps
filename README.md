...
**Description**: A web page that people would ask for a cab, with the backend done manually. A customer would order a taxi through the Easy Taxi website, giving their address and name. This process would generate an email to the founders, containing the information given by the customers, which they would use to call a cab company. This method did not require the creation of a robust system that tracks the location of the user, or that automatically finds a taxi driver based on the address of the customer, making it easier and cheaper to validate the hypothesis.

**Features**: The only feature of the website was the possibility of calling a taxi to your location, so you had to give some brief information, like your name, email, location, destination and the color of your outfit. After that, all you had to do was wait for the cab to arrive. The website provided a convenience to the customers, but it still required some effort, since you had to repeat your personal data every time you wanted another cab, and the UI was more designed for a desktop interface. The convenience was not at the quality the founders of Easy Taxi wanted to provide to their customers, but it was enough to see if their hypothesis was right.
...
**Description**: The MVP was a manual process, with no programming required or any use of external tools. The founders would talk to people, find out their preferences, go to the supermarkets and grocery stores to check the prices of the ingredients, and deliver them to their clients. It started with one client, and slowly escalated to more and more people. The founders were able to learn the nuances of this project, by talking to people and learning how the process works in practice, while also not spending any time or money on programming a very ambitious and complex app that they did not know if it had a future and a place on the market.

**Features**: The process allowed customers to tell what their preferences were, so the founders could come up with recipes and find out which locations had the best prices for the ingredients. These ingredients would be delivered to the customer's residence with the instructions to make the meal, and although the founders had to physically visit the grocery stores and the supermarket, the costumers didn't have to do anything but wait for the delivery, making the idea very appealing to those interested in cooking. There was no proper feature in this MVP that had to be implemented in an application, it was all an abstraction of the real product.
