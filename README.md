...
| **Customer Segment** | The project adjusts its current target market, either narrowing it down to a specific segment or expanding it to a broader audience. | <a href="#facebook">Facebook</a>, <a href="#airbnb">Airbnb</a> |
| **Value Capture** | The project undergoes significant changes to its current revenue model. | <a href="#spotify">Spotify</a> |
| **Platform Device** | The project undergoes a platform device change, shifting from a website-based operation to a downloadable desktop or mobile application, or vice versa. This change allows users to access the project's services and features in a different format that better suits their needs. | <a href="#easy-taxi">Easy Taxi</a> |
...
As time progressed, Facebook expanded its focus to become a social media platform for individuals beyond just Harvard students, which lead Zuckerberg to do a **Customer Segment pivot**. It gradually introduced additional features and adapted them to cater to a broader audience.
